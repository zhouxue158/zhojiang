<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\wamp\www\thinkphp_5.0.9_full\public/../application/admin\view\personal\index.html";i:1497855237;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="cl pd-20" style=" background-color:#5bacb6">
	...
	<dl style="margin-left:80px; color:#fff">
		<dt>
			<span class="f-18"><?php echo session('admin.username'); ?></span>
