<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\wamp\www\thinkphp_5.0.9_full\public/../application/admin\view\index\index.html";i:1499129761;}*/ ?>
<!DOCTYPE HTML>
<html>
	...
	<body>
		...
		<header class="navbar-wrapper">
			<div class="navbar navbar-fixed-top">
				<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="__STATIC__/admin/aboutHui.shtml">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="__STATIC__/admin/aboutHui.shtml">H-ui</a> 
					...
					<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
						<ul class="cl">
							...
							<li class="dropDown dropDown_hover">
								...
								<ul class="dropDown-menu menu radius box-shadow">
									<li><a href="<?php echo url('personal/index'); ?>" onClick="myselfinfo()">个人信息</a></li>
									<li><a href="<?php echo url('personal/modify'); ?>">修改密码</a></li>
		...
		<aside class="Hui-aside">
			...
			<div class="menu_dropdown bk_2">
				...
				<dl id="menu-article">
					...
					<dd>
						<ul>
							<li><a data-href="<?php echo url('merchant/index'); ?>" data-title="商家列表" href="javascript:void(0)">商户列表</a></li>
							<li><a data-href="<?php echo url('merchant/apply'); ?>" data-title="商家入驻申请" href="javascript:void(0)">商家入驻申请</a></li>
						</ul>
					</dd>
				</dl>
				...
				<dl id="menu-product">
					...
					<dd>
						<ul>
							<li><a data-href="<?php echo url('group/index'); ?>" data-title="商家团购提交" href="javascript:void(0)">商家团购提交</a></li>
							<li><a data-href="<?php echo url('group/purchase'); ?>" data-title="团购列表" href="javascript:void(0)">团购列表</a></li>
				...
				<dl id="menu-product">
					...
					<dd>
						<ul>
							<li><a data-href="<?php echo url('recommend/add'); ?>" data-title="添加推荐位内容" href="javascript:void(0)">添加推荐位内容</a></li>
							<li><a data-href="<?php echo url('recommend/index'); ?>" data-title="推荐位列表" href="javascript:void(0)">推荐位列表</a></li>
				...
				<dl id="menu-member">
					...
					<dd>
						<ul>
							...
							<li><a data-href="<?php echo url('member/index'); ?>" data-title="会员列表" href="javascript:;">会员列表</a></li>
