<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\wamp\www\thinkphp_5.0.9_full\public/../application/index\view\login\zhuce.html";i:1498641181;s:83:"D:\wamp\www\thinkphp_5.0.9_full\public/../application/index\view\public\header.html";i:1498449503;s:83:"D:\wamp\www\thinkphp_5.0.9_full\public/../application/index\view\public\footer.html";i:1498179978;}*/ ?>
<!--加载头部文件-->
...
<div class="denlu">
	<div class="denlu_nei">
        ...
        <div class="denluR">
			...
			<form  action="<?php echo url('login/zhuce'); ?>" method="post">
				...
				<div class="den_kang">
					<table width="100%" height="155" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tr >
							...
							<td><input name="username" type="text"  onkeyup="value=value.replace(/[^\w\d]/g,'')" class="denl_input" value=""  placeholder="邮箱/会员账号"/></td>
						  </tr>
						  ...
						  <tr>
						   ...
						   <tr>
							...
							<td><input name="password1" type="password" class="denl_input" placeholder="再次确认密码"/>
							</td>
						  </tr>
