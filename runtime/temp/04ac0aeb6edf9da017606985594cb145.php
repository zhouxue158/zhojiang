<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\wamp\www\thinkphp_5.0.9_full\public/../application/admin\view\category\edit.html";i:1498553041;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	...
	<form class="form form-horizontal form-o2o-add" id="form-o2o-add" method="post" action="<?php echo url('category/save'); ?>">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $categoryid->name; ?>" placeholder="" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="parent_id" class="select">
					...
					<option value="<?php echo $vo['id']; ?>" <?php if($categoryid->parent_id == $vo['id']): ?> selected="selected" <?php endif; ?>><?php echo $vo['name']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
				</span>
			</div>
		</div>
		<input type="hidden" name="id" value="<?php echo $categoryid->id; ?>">
		<div class="row cl">
