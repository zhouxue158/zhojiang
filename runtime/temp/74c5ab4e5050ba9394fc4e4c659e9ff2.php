<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\wamp\www\thinkphp_5.0.9_full\public/../application/admin\view\information\index.html";i:1497411307;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<!--[if IE 6]>
<script type="__STATIC__/admin/text/javascript" src="lib/DD_belatedPNG_0.0.8a-min.js" ></script>
...
<div class="cl pd-20" style=" background-color:#5bacb6">
	...
	<dl style="margin-left:80px; color:#fff">
		<dt>
			<span class="f-18"><?php echo session('admin.admin_username'); ?></span>
